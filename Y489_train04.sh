...
#SBATCH --job-name=Y489_train04
#SBATCH --array=11
#SBATCH --ntasks=1
#SBATCH --mem=120000
#SBATCH --partition=gpu
#SBATCH --gpus-per-node=1
#SBATCH --output=/camp/home/zhangy3/em-schafer-working/yuxin_scripts/Projects/CLEM/CLEM221010/Y489/15-SUPPORT/out/Y489_train04_%j.out
#SBATCH --error=/camp/home/zhangy3/em-schafer-working/yuxin_scripts/Projects/CLEM/CLEM221010/Y489/15-SUPPORT/out/Y489_train04_%j.err
...
yes | python -m src.train --exp_name Y489_train04 --noisy_data /camp/home/zhangy3/em-schafer-working/processed/CLEM2022/CLEM221010/Y489/18-2P_denoise_SURPPORT/test_data/plane4/Y489_s2p_reg_test_01_manualReg_chunk0_plane4.tif --n_epochs 40 --checkpoint_interval 10 --bs_size 20 20
